...
class TelegramAlarm(Alarm):
    ...
    _defaults = {  # No touchy!!! Edit alarms.json!
        'monsters': {
            ...
            'sticker_url': "https://raw.githubusercontent.com/mizu-github/PogoAssets/sugimori/pmsf_edge_80/pokemon_icon_<mon_id_3>_<form_id_2>.png"
        },
        'stops': {
        ...
        'raids': {
            'message': "*A raid is available against <mon_name>!*\n"
                       ...
                       "(<raid_time_left>).",
            'sticker_url':
                "https://raw.githubusercontent.com/mizu-github/PogoAssets/sugimori/pmsf_edge_80/pokemon_icon_<mon_id_3>_<form_id_2>.png"
        },
        'weather': {
    ...
    def send_sticker(self, token, chat_id, sticker_url,
        ...
        if "sugimori" not in sticker_url:
            args = {
